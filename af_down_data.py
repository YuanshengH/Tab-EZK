...
merge_csv = './data/test_split/tabular/merge/df_merge_tabular.csv'
...
work_dir = './data/AFDB/All_Structure'
url_template = "https://alphafold.ebi.ac.uk/files/AF-{}-F1-model_v6.pdb"
...
urls_file = './data/AFDB/url.txt'
with open(urls_file, "w") as f:
    f.write("\n".join(url_list))

cmd_str = f"aria2c --max-tries=10 --retry-wait=2 -i {urls_file} -x 16 -d {work_dir} -l ./data/AFDB/AF_structure/af_download.log"
cmd(cmd_str)
print()